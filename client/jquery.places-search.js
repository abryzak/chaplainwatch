...
(function() {
  ...
  function PlacesSearch(element, options) {
    ...
    console.log('Setting up places search');
  ...
  PlacesSearch.prototype = {
    ...
    getPredictions: function(query, process) {
      ...
      this.autocompleteService.getPlacePredictions({ input: query, componentRestrictions:{ country: 'au' }}, $.proxy(this.onGetPrediction, this, process));
    },
    ...
    onGetPlaceDetails:  function(result, status) {
      ...
      this.options.onSelectAddress(result, this.element[0]);
    },
    selectAddress: function(address) {
      ...
      // this returns the address to the textbox to show
      return address;
    }
  };
